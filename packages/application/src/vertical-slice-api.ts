...
export type VerticalSliceRpcFunctionName =
  ...
  | "m3_update_party"
  | "m3_archive_party"
  | "m3_add_party_contact"
  | "m3_add_party_address"
  | "m3_replace_party_identifier"
  | "m3_reveal_party_identifier"
  | "m3_add_party_relationship"
  ...
  | "m3_complete_task"
  | "m3_cancel_task"
  | "m3_create_appointment"
  | "m3_transition_appointment"
  | "m3_list_crm_timeline"
  | "m3_list_tasks"
  | "m3_list_appointments"
  | "m3_list_deals"
  | "m3_get_deal"
  | "m3_list_deal_participants"
  | "m3_list_deal_inventory"
  | "m3_list_deal_line_items"
  | "m3_create_deal"
  | "m3_update_deal"
  | "m3_transition_deal"
  | "m3_add_deal_participant"
  | "m3_release_deal_participant"
  | "m3_add_deal_inventory"
  | "m3_release_deal_inventory"
  | "m3_add_deal_line_item"
  | "m3_update_deal_line_item"
  | "m3_list_trade_ins"
  | "m3_create_trade_in"
  | "m3_update_trade_in"
  | "m3_confirm_trade_in_inventory"
  | "m3_list_finance_applications"
  | "m3_get_finance_application"
  | "m3_create_finance_application"
  | "m3_update_finance_application"
  | "m3_transition_finance_application"
  | "m3_add_finance_condition"
  | "m3_update_finance_condition"
  | "m3_list_payment_transactions"
  ...
  | "create_custom_field_version"
  | "activate_custom_field_version"
  | "set_custom_field_value"
  | "get_custom_field_values"
  | "m4_authorize_document_file_download"
  | "m4_authorize_export_download"
  | "m4_create_numbering_version"
  | "m4_get_document_detail"
  | "m4_get_export_run"
  | "m4_list_approval_records"
  | "m4_list_calculation_definitions"
  | "m4_list_document_types"
  | "m4_list_documents"
  | "m4_list_export_definitions"
  | "m4_list_numbering_definitions"
  | "m4_list_tax_packs"
  | "m4_load_calculation_preview_configuration"
  | "m4_load_deal_runtime_input"
  | "m4_load_tax_preview_configuration"
  | "m4_mark_document_signed"
  | "m4_record_artifact_approval"
  | "m4_report_deals"
  | "m4_report_inventory_aging"
  | "m4_report_inventory_gross"
  | "m4_report_leads"
  | "m4_request_document_preview"
  | "m4_request_export_run"
  | "m4_retry_document_render"
  | "m4_transition_artifact_version"
  | "m4_validate_document"
  | "m4_void_document"
